  ...
  return (
    <PublicLayout activeNav="home">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-brand-1">
                Real-Time Tracking.
              </h2>
      ...
      <section className="relative min-h-[280px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 flex flex-col sm:flex-row items-center justify-between gap-6 w-full">
